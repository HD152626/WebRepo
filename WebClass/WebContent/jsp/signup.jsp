...
<body>
	<div class="container">
		<form id="signupForm" class="form-signin" action="/WebClass/signup" method="post">
			...
			placeholder="Email address" <%if(request.getParameter("id") != null){%>value="<%=request.getParameter("id")%><% } %>"
			required autofocus>
			...
			<%if(request.getParameter("nickname") != null){%>value="<%=request.getParameter("nickname")%><% } %>" required> <br>
